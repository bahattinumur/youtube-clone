...
const SearchResult = () => {
  ...
  // 1) URL'de aratılan terimi al
  const [searchParams] = useSearchParams();
  const query = searchParams.get('search_query');

  // 2) API'dan yaratılan terime uygun verileri al
  // her yeni terim aratıldığında useEffect'in tekrar çalışmasını istiyoruz.
  // bu yüzden bağlılık dizisinin arama parametlereini verdik
  // pearemetreler her değiştiğinde useEffect tekrar çalışır
  useEffect(() => {
